                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable" >
                            ...
                            <?php
                                ...
                                foreach($comics as $row){
                                    ...
                                    if($checked == 0):
                                        echo "<td><a href='./action.php?key=checked&cid=" . $id . "&value=0' class='btn btn-default btn-circle'><i class='fa fa-check'></i></a>";
                                    else:
                                        echo "<td><a href='./action.php?key=checked&cid=" . $id . "&value=1' class='btn btn-info btn-circle'><i class='fa fa-check'></a>";
                                    endif;
                                    echo '<td>

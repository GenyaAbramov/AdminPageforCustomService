...
<?php require_once("./top_navigation.php") ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                <button id="download" style="float: right;margin-bottom: 20px;" type="button" class="btn btn-w-m btn-primary">
                    <a href="./action.php?key=download_csv" class="btn-primary" rel="tooltip">Download CSV</a>
                </button>
            </div>
            <div class="col-lg-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#download").click(function() {
                setTimeout("location.href = 'info.php'", 2000);
            });
        });
